...
while ($True) {
    $cond1 = "Veci buenas, queremos recordarle que los sabados, domingos y feriados, el plato tiene un precio especial de 13 soles. Esperamos que lo tenga en cuenta para sus siguientes pedidos! (;"
    $cond2 = "Muchas gracias veci"
    ...
    switch ($selection) {
        1 { $cond1 | Set-Clipboard }
        2 { $cond2 | Set-Clipboard }
        3 { 
